...
const getMessages = async(userId) =>{
    try {
        ...
        if(data.success){
            ...
            // Clear unseen messages for this user after reading
...
const getLastSeen = async (userId) => {
 ...
 const subscribeToMessages = async()=>{
    ...
    socket.on("newMessage",(newMessage)=>{
        ...
        // Reorder users list - move user with new message to top
        setUsers((prevUsers) => {
            const senderId = newMessage.senderId;
            const userIndex = prevUsers.findIndex(user => user._id === senderId);
